...
angular.module('conade.services', []).
  value('version', '0.1');

// phonegap ready service - listens to deviceready
conade.factory('phonegapReady', function() {
    return function (fn) {
        var queue = [];
        var impl = function () {
...
conade.factory('geolocation', function ($rootScope, phonegapReady) {
  return {
...
conade.factory('accelerometer', function ($rootScope, phonegapReady) {
    return {
...
conade.factory('notification', function ($rootScope, phonegapReady) {
    return {
...
conade.factory('navSvc', function($navigate) {
    return {
...
conade.factory('compass', function ($rootScope, phonegapReady) {
    return {
...
conade.factory('contacts', function ($rootScope, phonegapReady) {
    return {
